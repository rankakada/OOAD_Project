...
namespace Compuer_Shop_System_Management.PAL
{
    public partial class UserControlBrand : UserControl
    {
        ...
        private void txtSerchBrandName_TextChanged(object sender, EventArgs e)
        {
            Computer.Computer.DisplayAndSearch("SELECT * FROM Brand WHERE Brand_Name LIKE '%" + txtSerchBrandName.Text + "%';", dgvBrand);
            lblTotal.Text = dgvBrand.Rows.Count.ToString();
        }
